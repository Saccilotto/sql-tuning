...
--4- Listar as informa�oes sobre a estrutura e dados armazenados na tabela:
SELECT *
FROM ALL_TABLES
...
Relat�rio de erros -
ORA-02437: n�o � poss�vel validar (BI106097.PK_PESSOAS) - chave prim�ria violada
...
-- O que mudou?
 -- H� uma nova constranint do tipo P (private key) relacionado espeficamente ao meu schema,
